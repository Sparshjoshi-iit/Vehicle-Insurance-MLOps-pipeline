...
from src.constants import SAVED_MODEL_DIR
...
class TrainPipeline:
    def __init__(self):
        ...
        self.model_pusher_config = ModelPusherConfig(saved_model_dir=SAVED_MODEL_DIR)
    ...
    def start_model_evaluation(self,data_ingestion_artifact: DataIngestionArtifact,data_transformation_artifact: DataTransformationArtifact,
